...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source TuPac - اهلا بك في سورس ديفد ~"
...
wget "apiAhMd.ml/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
